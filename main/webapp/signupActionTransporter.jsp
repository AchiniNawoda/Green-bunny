    ...
    try
{
	...
	PreparedStatement ps = con.prepareStatement("insert into transporters values(?,?,?,?,?,?,?)");
	...
	ps.executeUpdate();
	response.sendRedirect("loginTransporter.jsp?msg=valid");
	
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("signupTransporter.jsp?msg=invalid");
}
}
