...
<title>GB Transporter - Sign up</title>
...
<div id='container'>
  <div class='signup'>
  <h1>Welcome to The GreenBunny Transporters Community</h1>
  <p></p>
  
           <form action="signupActionTransporter.jsp" name="registrationForm" method="post" onsubmit="return validateForm()">
...
<a href="index.jsp"><button type="submit">Sign Up</button></a>
      ...
      <h4>Already have an account? <br><br><a href="loginTransporter.jsp"> Login </a></h4>
