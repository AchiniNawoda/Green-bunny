...
<div class="text"><br><br>
            ...
            <h3>Welcome GB Farmer</h3><br><br>
<br>            
			<p>Choose an Action:</p><br>
			
    
    		<a href="#">...</a>
            <a href="addNewProductAction.jsp">Add Product</a>
            <a href="farmerProfile.jsp">View Profile</a>
            <a href="#">...</a>
