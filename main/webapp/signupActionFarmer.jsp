    ...
    try
{
	...
	PreparedStatement ps = con.prepareStatement("insert into farmers values(?,?,?,?,?,?,?)");
	...
	ps.executeUpdate();
	response.sendRedirect("loginFarmer.jsp?msg=valid");
	
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("signupFarmer.jsp?msg=invalid");
}
}
/* 
try
